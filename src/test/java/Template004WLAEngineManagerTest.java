...
public class Template004WLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(Template004WLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/Template004WLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/Template004WLAIW/InitOutcome.xml").getDocumentElement();
